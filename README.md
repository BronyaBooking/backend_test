...
## 1. Поставить заранее, до созвона

Чтобы не тратить время на настройку, когда включится таймер:
...
Архив с проектом или ссылку на форк. Внутри:

- ваш код;
- одна строка о том, сколько реально заняло времени;
- всё, что вы захотите нам сказать про проект, — свободным текстом в любом файле;
- если пользовались ИИ — промпты или ссылка на диалог. Это плюс, а не минус:
  нам интересно, как вы с ним спорили.

Если что-то не запускается вообще — напишите нам. Это тоже результат, а не провал.
Не тратьте на настройку больше пяти минут.
